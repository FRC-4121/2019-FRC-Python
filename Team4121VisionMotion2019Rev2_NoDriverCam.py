...
def main():
    ...
    try:
        ...
        visionCamera.setVideoMode(cs.VideoMode.PixelFormat.kMJPEG, imgWidthVision, imgHeightVision, visionFramesPerSecond)
    ...
    while (True):
        ...
        #Check video network table boolean value
        writeVideo = visionTable.getBoolean("WriteVideo", True)
